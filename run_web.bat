...
echo ============================================
echo   자산관리 웹앱 실행  -  http://localhost:8000/app/
...
REM 3초 뒤 기본 브라우저로 자동 접속 (Figma React 앱 = /app/)
start "" /b powershell -NoProfile -WindowStyle Hidden -Command "Start-Sleep -Seconds 3; Start-Process 'http://localhost:8000/app/'"
